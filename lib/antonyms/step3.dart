...
class AntoStep3 extends StatefulWidget {
  const AntoStep3({super.key});

  @override
  State<AntoStep3> createState() => _AntoStep3State();
}

class _AntoStep3State extends State<AntoStep3> {
          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.antoScore<160?true:false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.antoScore<170?true:false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.antoScore<180?true:false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.antoScore<190?true:false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.antoScore<200?true:false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.antoScore<210?true:false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.antoScore<220?true:false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.antoScore<230?true:false,
              ),
            ],
          ),
