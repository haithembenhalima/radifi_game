...
class AntoStep6 extends StatefulWidget {
  const AntoStep6({super.key});

  @override
  State<AntoStep6> createState() => _AntoStep6State();
}

class _AntoStep6State extends State<AntoStep6> {
          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.antoScore < 400 ? true : false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 410 ? true : false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 420 ? true : false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 430 ? true : false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 440 ? true : false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 450 ? true : false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 460 ? true : false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 470 ? true : false,
              ),
            ],
          ),

          if (AntoStaticIndexes.openSection2 == 1 ||
