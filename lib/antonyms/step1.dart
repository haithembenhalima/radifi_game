...
class AntoStep1 extends StatefulWidget {
  const AntoStep1({super.key});

  @override
  State<AntoStep1> createState() => _AntoStep1State();
}

class _AntoStep1State extends State<AntoStep1> {
          ...
          Wrap(
            ...
            children: [
              ...
              sectionButton(
                ...
                isDisable: Score.antoScore < 10 ? true : false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 20 ? true : false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 30 ? true : false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 40 ? true : false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 50 ? true : false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 60 ? true : false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.antoScore < 70 ? true : false,
              ),
            ],
          ),
