...
class AntoStep4 extends StatefulWidget {
  const AntoStep4({super.key});

  @override
  State<AntoStep4> createState() => _AntoStep4State();
}

class _AntoStep4State extends State<AntoStep4> {
          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.antoScore<240?true:false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.antoScore<250?true:false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.antoScore<260?true:false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.antoScore<270?true:false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.antoScore<280?true:false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.antoScore<290?true:false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.antoScore<300?true:false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.antoScore<310?true:false,
              ),
            ],
          ),
