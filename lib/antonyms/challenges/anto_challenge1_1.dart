...
class AntoChallenge1_1 extends StatefulWidget {
  const AntoChallenge1_1({super.key});

  @override
  State<AntoChallenge1_1> createState() => _AntoChallenge1_1State();
}
...
class _AntoChallenge1_1State extends State<AntoChallenge1_1> {
  @override
  void initState() {
    ...
    // step1
    if (AntoStaticIndexes.step == 4 && AntoStaticIndexes.section == 5) {
      questions = data4.Step4Section5;
      alphabet = data4.alphabet1;
    }
    if (AntoStaticIndexes.step == 4 && AntoStaticIndexes.section == 6) {
      questions = data4.Step4Section6;
      alphabet = data4.alphabet2;
    }

    if (AntoStaticIndexes.step == 4 && AntoStaticIndexes.section == 7) {
      questions = data4.Step4Section7;
      alphabet = data4.alphabet3;
    }
    if (AntoStaticIndexes.step == 5 && AntoStaticIndexes.section == 5) {
      questions = data5.Step5Section5;
      alphabet = data5.alphabet1;
    }

    if (AntoStaticIndexes.step == 5 && AntoStaticIndexes.section == 6) {
      questions = data5.Step5Section6;
      alphabet = data5.alphabet2;
    }

    if (AntoStaticIndexes.step == 5 && AntoStaticIndexes.section == 7) {
      questions = data5.Step5Section7;
      alphabet = data5.alphabet3;
    }
    if (AntoStaticIndexes.step == 6 && AntoStaticIndexes.section == 5) {
      questions = data6.Step6Section5;
      alphabet = data6.alphabet1;
    }

    if (AntoStaticIndexes.step == 6 && AntoStaticIndexes.section == 6) {
      questions = data6.Step6Section6;
      alphabet = data6.alphabet2;
    }

    if (AntoStaticIndexes.step == 6 && AntoStaticIndexes.section == 7) {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => AntoChallenge1_1()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
