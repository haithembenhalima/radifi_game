...
class AntoChallenge1 extends StatefulWidget {
  const AntoChallenge1({super.key});

  @override
  State<AntoChallenge1> createState() => _antoChallenge1State();
}
...
class _antoChallenge1State extends State<AntoChallenge1> {
  @override
  void initState() {
    ...
    // step1
    if (AntoStaticIndexes.step == 1 && AntoStaticIndexes.section == 5) {
      questions = data1.Step1Section5;
      alphabet = data1.alphabet1;
    }

    if (AntoStaticIndexes.step == 1 && AntoStaticIndexes.section == 6) {
      questions = data1.Step1Section6;
      alphabet = data1.alphabet2;
    }

    if (AntoStaticIndexes.step == 1 && AntoStaticIndexes.section == 7) {
      questions = data1.Step1Section7;
      alphabet = data1.alphabet3;
    }
    if (AntoStaticIndexes.step == 2 && AntoStaticIndexes.section == 5) {
      questions = data2.Step2Section5;
      alphabet = data2.alphabet1;
    }

    if (AntoStaticIndexes.step == 2 && AntoStaticIndexes.section == 6) {
      questions = data2.Step2Section6;
      alphabet = data2.alphabet2;
    }

    if (AntoStaticIndexes.step == 2 && AntoStaticIndexes.section == 7) {
      questions = data2.Step2Section7;
      alphabet = data2.alphabet3;
    }
    if (AntoStaticIndexes.step == 3 && AntoStaticIndexes.section == 5) {
      questions = data3.Step3Section5;
      alphabet = data3.alphabet1;
    }

    if (AntoStaticIndexes.step == 3 && AntoStaticIndexes.section == 6) {
      questions = data3.Step3Section6;
      alphabet = data3.alphabet2;
    }

    if (AntoStaticIndexes.step == 3 && AntoStaticIndexes.section == 7) {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => AntoChallenge1()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
