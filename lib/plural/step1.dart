...
class PluralStep1 extends StatefulWidget {
  const PluralStep1({super.key});

  @override
  State<PluralStep1> createState() => _PluralStep1State();
}

class _PluralStep1State extends State<PluralStep1> {
          ...
          Wrap(
            ...
            children: [
              ...
              sectionButton(
                ...
                isDisable: Score.pluralScore<10?true:false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<20?true:false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<30?true:false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<40?true:false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<50?true:false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<60?true:false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<70?true:false,
              ),
            ],
          ),
