...
class PluralStep5 extends StatefulWidget {
  const PluralStep5({super.key});

  @override
  State<PluralStep5> createState() => _PluralStep5State();
}

class _PluralStep5State extends State<PluralStep5> {
          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.pluralScore<320?true:false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<330?true:false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<340?true:false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<350?true:false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<360?true:false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<370?true:false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<380?true:false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<390?true:false,
              ),
            ],
          ),
