...
class PluralStep4 extends StatefulWidget {
  const PluralStep4({super.key});

  @override
  State<PluralStep4> createState() => _pluralStep4State();
}

class _pluralStep4State extends State<PluralStep4> {
          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.pluralScore<240?true:false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<250?true:false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<260?true:false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<270?true:false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<280?true:false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<290?true:false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<300?true:false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.pluralScore<310?true:false,
              ),
            ],
          ),
