...
class PluralChallenge4 extends StatefulWidget {
  const PluralChallenge4({super.key});

  @override
  State<PluralChallenge4> createState() => _PluralChallenge4State();
}
...
class _PluralChallenge4State extends State<PluralChallenge4> {
  @override
  void initState() {
    ...
    // step1
    if (pluralStaticIndexes.step == 1 && pluralStaticIndexes.section == 8) {
      questions = data1.Step1Section8;
    }

    if (pluralStaticIndexes.step == 2 && pluralStaticIndexes.section == 8) {
      questions = data2.Step2Section8;
    }

    if (pluralStaticIndexes.step == 3 && pluralStaticIndexes.section == 8) {
      questions = data3.Step3Section8;
    }

    if (pluralStaticIndexes.step == 4 && pluralStaticIndexes.section == 8) {
      questions = data4.Step4Section8;
    }

    if (pluralStaticIndexes.step == 5 && pluralStaticIndexes.section == 8) {
      questions = data5.Step5Section8;
    }

    if (pluralStaticIndexes.step == 6 && pluralStaticIndexes.section == 8) {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => PluralChallenge4()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
