...
class PluralChallenge1_1 extends StatefulWidget {
  const PluralChallenge1_1({super.key});

  @override
  State<PluralChallenge1_1> createState() => _PluralChallenge1_1State();
}
...
class _PluralChallenge1_1State extends State<PluralChallenge1_1> {
  @override
  void initState() {
    ...
    // step1
    if (pluralStaticIndexes.step == 4 && pluralStaticIndexes.section == 5) {
      questions = data4.Step4Section5;
      alphabet = data4.alphabet1;
    }
    if (pluralStaticIndexes.step == 4 && pluralStaticIndexes.section == 6) {
      questions = data4.Step4Section6;
      alphabet = data4.alphabet2;
    }

    if (pluralStaticIndexes.step == 4 && pluralStaticIndexes.section == 7) {
      questions = data4.Step4Section7;
      alphabet = data4.alphabet3;
    }
    if (pluralStaticIndexes.step == 5 && pluralStaticIndexes.section == 5) {
      questions = data5.Step5Section5;
      alphabet = data5.alphabet1;
    }

    if (pluralStaticIndexes.step == 5 && pluralStaticIndexes.section == 6) {
      questions = data5.Step5Section6;
      alphabet = data5.alphabet2;
    }

    if (pluralStaticIndexes.step == 5 && pluralStaticIndexes.section == 7) {
      questions = data5.Step5Section7;
      alphabet = data5.alphabet3;
    }
    if (pluralStaticIndexes.step == 6 && pluralStaticIndexes.section == 5) {
      questions = data6.Step6Section5;
      alphabet = data6.alphabet1;
    }

    if (pluralStaticIndexes.step == 6 && pluralStaticIndexes.section == 6) {
      questions = data6.Step6Section6;
      alphabet = data6.alphabet2;
    }

    if (pluralStaticIndexes.step == 6 && pluralStaticIndexes.section == 7) {
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                        builder: (context) => PluralChallenge1_1()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
