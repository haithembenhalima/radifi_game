...
class SynoChallenge1 extends StatefulWidget {
  const SynoChallenge1({super.key});

  @override
  State<SynoChallenge1> createState() => _SynoChallenge1State();
}
...
class _SynoChallenge1State extends State<SynoChallenge1> {
  @override
  void initState() {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => SynoChallenge1()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
