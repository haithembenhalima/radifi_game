...
class SynoChallenge4 extends StatefulWidget {
  const SynoChallenge4({super.key});

  @override
  State<SynoChallenge4> createState() => _SynoChallenge4State();
}
...
class _SynoChallenge4State extends State<SynoChallenge4> {
  @override
  void initState() {
    ...
    // step1
    if (StaticIndexes.step == 1 && StaticIndexes.section == 8) {
      questions = data1.Step1Section8;
    }

    if (StaticIndexes.step == 2 && StaticIndexes.section == 8) {
      questions = data2.Step2Section8;
    }

    if (StaticIndexes.step == 3 && StaticIndexes.section == 8) {
      questions = data3.Step3Section8;
    }

    if (StaticIndexes.step == 4 && StaticIndexes.section == 8) {
      questions = data4.Step4Section8;
    }

    if (StaticIndexes.step == 5 && StaticIndexes.section == 8) {
      questions = data5.Step5Section8;
    }

    if (StaticIndexes.step == 6 && StaticIndexes.section == 8) {
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (context) => SynoChallenge4()),
                    (Route<dynamic> route) => false,
                  );
                },
                child:
