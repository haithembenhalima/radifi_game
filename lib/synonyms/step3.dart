          ...
          Wrap(
            ...
            children: [
              sectionButton(
                ...
                isDisable: Score.synoScore < 160 ? true : false,
              ),
              sectionButton(
                title: "2",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 170 ? true : false,
              ),
              sectionButton(
                title: "3",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 180 ? true : false,
              ),
              sectionButton(
                title: "4",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 190 ? true : false,
              ),
              sectionButton(
                title: "5",
                onPressed: () {
                  Navigator.of(context).pushNamed("syno_challenge1");
                  StaticIndexes.section = 5;
                },
                isDisable: Score.synoScore < 200 ? true : false,
              ),
              sectionButton(
                title: "6",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 210 ? true : false,
              ),
              sectionButton(
                title: "7",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 220 ? true : false,
              ),
              sectionButton(
                title: "8",
                onPressed: () {
                ...
                isDisable: Score.synoScore < 230 ? true : false,
              ),
            ],
          ),
